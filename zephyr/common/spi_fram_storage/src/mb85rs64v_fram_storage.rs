...
pub struct MB85RS64VFramStorageModule {
    spi_spec: SPISpec
}

impl MB85RS64VFramStorageModule {
    ...
    pub unsafe fn new() -> Result<Self, ()> {
        if ALREADY_INITIALIZED.swap(true, core::sync::atomic::Ordering::SeqCst) {
            ...
            // this module
            panic!("Creating multiple instances of \"MB85RS64VFramStorageModule\" is invalid!");
        }
...
impl Drop for MB85RS64VFramStorageModule {
    fn drop(&mut self) {
        ALREADY_INITIALIZED.store(false, core::sync::atomic::Ordering::SeqCst);
    }
}

impl PersistentStorageModule for MB85RS64VFramStorageModule {
