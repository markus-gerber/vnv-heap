...
use super::{model::MemoryManager, AllocatorModule, Benchmark, LinkedListAllocatorModule, ModuleOptionsBaseline, Timer};
...
#[derive(Serialize)]
pub struct BaselineAllocateMaxMinBenchmarkOptions {
    object_size: usize,
    bucket_size: usize,
    modules: ModuleOptionsBaseline,
}

pub struct BaselineAllocateMaxMinBenchmark<
    'a,
    'b: 'a,
...
impl<
        ...
        A: AllocatorModule + 'static,
        S: PersistentStorageModule
    > BaselineAllocateMaxMinBenchmark<'a, 'b, OBJ_SIZE, BUCKET_SIZE, A, S>
{
...
impl<
        ...
        A: AllocatorModule + 'static,
        S: PersistentStorageModule
    > Benchmark<BaselineAllocateMaxMinBenchmarkOptions>
    for BaselineAllocateMaxMinBenchmark<'a, 'b, OBJ_SIZE, BUCKET_SIZE, A, S>
{
    #[inline]
    fn get_name(&self) -> &'static str {
        "baseline_allocate_max_min"
    }
    ...
    #[inline]
    fn get_bench_options(&self) -> BaselineAllocateMaxMinBenchmarkOptions {
        BaselineAllocateMaxMinBenchmarkOptions {
