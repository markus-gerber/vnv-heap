...
#[derive(Serialize)]
pub struct BaselineDeallocateMaxBenchmarkOptions {
    object_size: usize,
    bucket_size: usize,
    modules: ModuleOptionsBaseline,
}

pub struct BaselineDeallocateMaxBenchmark<
    'a,
    'b: 'a,
...
impl<
        ...
        A: AllocatorModule + 'static,
        S: PersistentStorageModule
    > BaselineDeallocateMaxBenchmark<'a, 'b, OBJ_SIZE, BUCKET_SIZE, A, S>
{
...
impl<
        ...
        A: AllocatorModule + 'static,
        S: PersistentStorageModule
    > Benchmark<BaselineDeallocateMaxBenchmarkOptions>
    for BaselineDeallocateMaxBenchmark<'a, 'b, OBJ_SIZE, BUCKET_SIZE, A, S>
{
    #[inline]
    fn get_name(&self) -> &'static str {
        "baseline_deallocate_max"
    }
    ...
    #[inline]
    fn get_bench_options(&self) -> BaselineDeallocateMaxBenchmarkOptions {
        BaselineDeallocateMaxBenchmarkOptions {
